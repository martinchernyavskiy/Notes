### Theorem: Let $T: V \to W$ be a linear map between vector spaces of same finite dimension. Then if the transformation is either one-to-one, onto, or rank(T) = dim(V), then the rest properties also hold.
?
